...
export class SOA_Record implements ResourceRecord<RDataMap[DNS_TYPES.SOA]> {
  readonly name: string;
  readonly type: DNS_TYPES.SOA;
  readonly RR_class: DNS_CLASSES;
  readonly ttl: number;
  readonly rdLength: number;
  readonly rData: RDataMap[DNS_TYPES.SOA];
